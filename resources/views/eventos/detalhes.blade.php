       ...
       <div class="card card-plain card-blog ml-2 mr-2">
            <div class="row">
                ...
                <div class="col-lg-10 col-md-10">
                    ...
                    <p class="mb-1"><strong>Horário Término</strong>: {{ \Carbon\Carbon::parse($evento->dt_termino_eve)->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($evento->hora_fim_eve)->format('H:i') }}</p>
