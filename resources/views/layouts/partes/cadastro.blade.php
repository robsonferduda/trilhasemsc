           ...
           <div class="card-body">
              <form>
                 ...
                 <div class="form-check form-check-info text-left">
                    ...
                    I agree the <a href="../../pages/privacy.html" class="text-dark font-weight-bold text-decoration-underline-hover">Terms and Conditions</a>
                    </label>
                 </div>
                 <div class="text-center">
                    <button type="button" class="btn bg-gradient-dark w-40 my-4 mb-2">Sign up</button>
                 </div>
                 <p class="text-sm mt-3 mb-0">Já possui uma conta? <a href="{{ url('login') }}" class="text-dark font-weight-bold text-decoration-underline-hover">Clique aqui</a></p>
              </form>
           </div>
        </div>
     </div>
