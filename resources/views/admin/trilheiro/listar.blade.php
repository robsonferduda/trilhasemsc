                            ...
                            <div class="col-lg-10 col-md-8 col-sm-12">
                                <div class="row">
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        ...
                                        <p><strong>Data de Nascimento</strong>: {{ ($trilheiro->dt_nascimento) ? \Carbon\Carbon::parse($trilheiro->dt_nascimento)->format('d/m/Y').' '.\Carbon\Carbon::parse($trilheiro->dt_nascimento)->age : 'Não Informada' }}</p>
