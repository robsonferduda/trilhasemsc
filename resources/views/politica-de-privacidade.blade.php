...
@section('content')
        <div class="portfolio-area portfolio-two">
            <div class="container">
                ...
                <div class="row">
                <p>A sua privacidade é importante para nós. É política do Trilhas em SC respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=https://trilhasemsc.com.br>Trilhas em SC</a>, e outros sites que possuímos e operamos.</p>
                ...
                <h3>Política de Cookies Trilhas em SC</h3>
