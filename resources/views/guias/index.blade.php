                    ...
                    <div class="row">
                        <div class="col-md-3">
                            @if($guia->nm_path_logo_gui)
                                <img class="custom-circle-image mb-3 mb-md-0" src="{{ asset('img/guias/'.$guia->nm_path_logo_gui) }}" alt="Logo Guia {{ $guia->nm_guia_gui }}">
                            @else
                                <img class="custom-circle-image mb-3 mb-md-0" src="{{ asset('img/guias/default.png') }}" alt="Logo Guia {{ $guia->nm_guia_gui }}">
                            @endif
                        </div>
                        <div class="col-md-9">
