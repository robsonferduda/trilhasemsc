                ...
                @foreach($guias as $key => $guia)
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <a style="margin-top: 5px"  class="btn btn-success" href="{{ url("guia/perfil/estatistica/telefone", $guia->id_guia_gui) }}"><i class="fa fa-whatsapp" aria-hidden="true"></i> Enviar Mensagem</a>
                            <a style="margin-top: 5px"  class="btn btn-primary mr-2 ml-3" href="{{ url("guia/perfil/estatistica/perfil", $guia->id_guia_gui) }}"><i class="fa fa-user" aria-hidden="true"></i> Perfil Completo</a>
                        </div>
                    </div>
